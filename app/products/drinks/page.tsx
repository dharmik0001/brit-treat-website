  ...
  const drinksProducts = [
    {
      ...
      imageAlt: "Red Grape Sparkling Drink",
      title: "Red Grape Sparkling Drink",
      description:
        "Refreshing non-alcoholic sparkling red grape beverage, perfect for celebrations and special occasions.",
    },
    {
      id: "white-grape-drink",
      imageSrc: "/brit-treat-white-grape-drink.jpeg",
      imageAlt: "White Grape Sparkling Drink",
      title: "White Grape Sparkling Drink",
      description:
        "Crisp and refreshing non-alcoholic sparkling white grape drink with a delicate, sophisticated taste.",
    },
  ]

  // Mobile gallery items
  const drinksGalleryItems = drinksProducts.map((product) => ({
      ...
      <section className="relative py-16 md:py-24 bg-gradient-to-br from-[#0A3281] to-[#1E4498] overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-wide">OUR DRINKS RANGE</h1>
